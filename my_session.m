function session = my_session(input1,varargin)
...
defaults.animal.name = 'Mouse'; % Animal name is inferred from the data path
...
defaults.extracellular.nChannels = 61;       % number of channels
